 ...
 */
#ifndef ITBF_QUEUE_DISC_H
#define ITBF_QUEUE_DISC_H
 ...
 */
class ITbfQueueDisc : public QueueDisc
{
public:
  ...
  /**
   * \brief ITbfQueueDisc Constructor
   *
...
private:
  ...
  Callback<void> m_masterRun; //!<  call the master Queue run

};

} // namespace ns3

#endif /* ITBF_QUEUE_DISC_H */
