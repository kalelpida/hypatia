...
#ifndef POINT_TO_POINT_NET_DEVICE_TRACEN_H
#define POINT_TO_POINT_NET_DEVICE_TRACEN_H
...
class PointToPointTracenChannel;
class ErrorModel;
 ...
 * 
 * 
 * Some of this device callback trace also node, which is easier to handle in my case than IP addresses
 */

/**
 * \ingroup point-to-point
 * \class PointToPointTracenNetDevice
 * \brief A Device for a Point to Point Network Link.
 *
 * This PointToPointTracenNetDevice class specializes the NetDevice abstract
 * base class.  Together with a PointToPointTracenChannel (and a peer 
 * PointToPointTracenNetDevice), the class models, with some level of 
 ...
 * propagation delay is set in the PointToPointTracenChannel).
 */
class PointToPointTracenNetDevice : public NetDevice
{
public:
  /**
  ...
  /**
   * Construct a PointToPointTracenNetDevice
   *
   * This is the constructor for the PointToPointTracenNetDevice.  It takes as a
   * parameter a pointer to the Node to which this device is connected, 
   * as well as an optional DataRate object.
   */
  PointToPointTracenNetDevice ();

  /**
   * Destroy a PointToPointTracenNetDevice
   *
   * This is the destructor for the PointToPointTracenNetDevice.
   */
  virtual ~PointToPointTracenNetDevice ();
   ...
   */
  bool Attach (Ptr<PointToPointTracenChannel> ch);

  /**
   * Attach a queue to the PointToPointTracenNetDevice.
   *
   * The PointToPointTracenNetDevice "owns" a queue that implements a queueing 
  ...
  /**
   * Attach a receive ErrorModel to the PointToPointTracenNetDevice.
   *
   * The PointToPointTracenNetDevice may optionally include an ErrorModel in
  ...
  /**
   * Receive a packet from a connected PointToPointTracenChannel.
   *
   * The PointToPointTracenNetDevice receives packets from its connected channel
...
private:
   ...
   */
  PointToPointTracenNetDevice& operator = (const PointToPointTracenNetDevice &o);
   ...
   * \param o Other NetDevice
   */
  PointToPointTracenNetDevice (const PointToPointTracenNetDevice &o);
...
private:
   ...
   * PointToPointTracenNetDevice to begin the process of sending a packet out on
   * the channel.  The corresponding method is called on the channel to let
   * it know that the physical device this class represents has virtually
   * started sending signals.  An event is scheduled for the time at which
   * the bits have been completely transmitted.
   *
   * \see PointToPointTracenChannel::TransmitStart ()
  ...
  /**
   * The PointToPointTracenChannel to which this PointToPointTracenNetDevice has been
   * attached.
   */
  Ptr<PointToPointTracenChannel> m_channel;

  /**
   * The Queue which this PointToPointTracenNetDevice uses as a packet source.
   * Management of this Queue has been delegated to the PointToPointTracenNetDevice
